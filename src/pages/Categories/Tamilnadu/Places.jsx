...
import heroImg from "../../../assets/states/tamil-nadu/categories/places/hero.jpg";
...
function Places() {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description:
        "Sacred temples, royal capitals and coastal towns evolved into vibrant cultural destinations that continue to define Tamil Nadu's heritage today.",
      image: timeline3,
